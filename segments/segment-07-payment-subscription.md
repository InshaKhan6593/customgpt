# MODULE: Payment & Subscription Architecture

**Type:** Cross-cutting concern (monetization layer)
**Depends on:** Segment 05 (feature flag), Segment 06 (Stripe integration)
**Referenced by:** Segment 06, Segment 07 (Payouts), Segment 10 (Orchestration billing), Segment 11 (Composability revenue)
...
When a developer builds a composite weblet that uses other developers' weblets as children (Segment 11), revenue must be distributed fairly.
...
- **Segment 06** — Builds the Stripe integration (Products, Checkout, webhooks)
- **Segment 07** — Payouts: developers withdraw their earnings (PayPal or Stripe payouts via Connect)
- **Segment 10** — Orchestration billing: how flows with paid weblets are handled
- **Segment 11** — Composability revenue: how child weblet developers are compensated
