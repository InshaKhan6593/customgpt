# Segment 08: Developer Dashboard & Analytics
...
The weblet's position within its category in the marketplace. Example: "Rank #2 in Writing" with a link to the category page. Calculated by the ranking algorithm from MODULE-categories-discovery.
...
For weblets that have opted into RSIL (Segment 13):
