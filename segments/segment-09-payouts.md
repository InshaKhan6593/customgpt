# Segment 09: Payouts & Creator Economics

**Estimated effort:** 1.5 weeks
**Depends on:** Segment 08 (Creator Dashboard — balance data visible)
...
## What Already Exists (from Segments 1-7)

```
Database:
  User.balance — Decimal field, updated by Stripe webhook on invoice.paid (Segment 06)
...
Dashboard:
  Creator can see weblet revenue in analytics (Segment 08)
```
...
- **Available Balance** = `User.balance` (already calculated by Segment 06 webhook)
